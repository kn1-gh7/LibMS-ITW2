USE library_205;
DROP TABLE IF EXISTS genres, books, users,library_db, transaction_types, lib_transactions;
...
INSERT INTO books
VALUES
    ('9780451524935', 'To Kill a Mockingbird', 'Harper Lee'    , 1, 1960, 'A classic novel about racial injustice in the American South.'),
    ('9780141983769', '1984', 'George Orwell'                  , 2, 1949, 'A dystopian novel depicting a totalitarian society.'),
    ('9780061120084', 'The Catcher in the Rye', 'J.D. Salinger', 1, 1951, 'A coming-of-age novel about a disenchanted teenager.'),
    ('9780062315007', 'The Great Gatsby', 'F. Scott Fitzgerald', 2, 1925, 'A story of wealth, excess, and the American Dream.'),
    ('9780141439563', 'Pride and Prejudice', 'Jane Austen'     , 3, 1813, 'A romantic novel revolving around the Bennet family.'),
    ('9780451527745', 'Moby-Dick', 'Herman Melville'           , 4, 1851, 'An epic tale of a man\'s obsession with a white whale.'),
    ('9780060256654', 'Alice\'s Adventures in Wonderland', 'Lewis Carroll', 5, 1865, 'A whimsical fantasy story about a girl named Alice.'),
    ('9780141439594', 'Jane Eyre', 'Charlotte Brontë'          , 3, 1847, 'A Gothic romance novel featuring the character Jane Eyre.'),
    ('9780451524936', 'The Hobbit', 'J.R.R. Tolkien'           , 5, 1937, 'A fantasy novel about the adventures of Bilbo Baggins.'),
    ('9780061120060', 'The Lord of the Rings', 'J.R.R. Tolkien', 5, 1954, 'A high-fantasy epic set in the fictional world of Middle-earth.');
