    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "genres",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="main.genres"
                    ),
                ),
            ],
        ),
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("total_count__gt", models.F("issued_count")),
                    ("issued_count__gte", 0),
                ),
                name="not_more_books_issued",
                violation_error_message="ERROR: Either trying to return a book which was not issued, or trying to issue more books that available!",
            ),
        ),
    ]
